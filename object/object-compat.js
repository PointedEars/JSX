...
jsx.importFrom = (function () {
   ...
   * @param properties : optional Array
   ...
   */
  return function (uri, obj, properties, objAlias, propertyAliases) {
    /* One-time import */
    if (!Request)
    {
