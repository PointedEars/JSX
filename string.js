 ...
 * @namespace
 */
jsx.string = (/** @constructor */ function () {
  /* Imports */
  var _jsx = jsx;
  ...
  return {
     ...
     */
    escape: (function () {
      return (typeof _global.encodeURIComponent == "function"
        ? _global.encodeURIComponent
        : (typeof _global.escape == "function"
            ? _global.escape
            : function (s) { return s; }));
    }()),
     ...
     */
    escapeURI: (function () {
      return (typeof _global.encodeURI == "function"
        ? _global.encodeURI
        : function (s) { return s; });
    }()),
     ...
     *   is not possible.
     * @partof http://PointedEars.de/scripts/string.js
     * @author Copyright (c) 2006-2008, 2013 Thomas Lahn <cljs@PointedEars.de>
     */
    unescape: (function () {
      return (typeof _global.decodeURIComponent == "function"
        ? _global.decodeURIComponent
        : (typeof _global.unescape == "function"
           ? _global.unescape
           : function (s) { return s; }));
    }()),
     ...
     *
     * Replaces the built-in function in that it supports fractional
...
// }
    ...
    /**
     * {@link #sprintf()} format specification.
     *
     * Can be overwritten to support different formats in an
     * overwritten <code>jsx.string.sprintf()</code>.
     */
    _rxPrintfSpec: _rxPrintfSpec,

    /**
     * Returns a string of values according to a format string.
     * (A more efficient rewrite of the previous format() function.)
     * <p>
     * This is an approach to implement <code>sprintf</code>(3)
     * in an ECMAScript compliant implementation out of its man page
     * documentation.  The syntax is intended to be compatible to
     * that of the <code>sprintf()</code> C function eventually.
     * Currently supported <code>sprintf</code>(3) features are:
     * </p><ul>
     *   <li>Replacing tags in a format string with a value given
     *       as argument: <code>%d</code></li>
     *   <li>Padding that value with zeroes or (non-breaking) spaces
     *       on the left, considering negative values: <code>%42d</code>,
     *       <code>% 42d</code>, and <code>%042d</code></li>
     *   <li>Padding that value with (non-breaking) spaces on the right:
     *       <code>%-42d</code></li>
     *   <li>Using arguments to specify the field width:
     *       <code>%*d</code> and <code>%*7$d</code></li>
     *   <li>Specifying positive precision (round after point):
     *       <code>%.2d</code></li>
     *   <li>Replacing <code>%%</code> with <code>%</code> without
     *       using an argument's value</li>
     * </ul>
     * <p>
     * Additional features supported by this method are:
     * </p><ul>
     *   <li>Specifying negative precision (round before point):
     *       <code>%.-2d</code></li>
     *   <li>If <code>%,42s</code> or <code>%;42s</code> are used,
     *       and the argument refers to an {@link Array}, it is
     *       expanded to a character string consisting of the
     *       comma-separated or semicolon-separated string
     *       representations of the elements, each of them having
     *       the format specification (here: field width=42) applied
     *       to it. If <code>,</code> is missing, the delimiter is
     *       the empty string, meaning that <code>Array</code>s of
     *       <code>Strings</code> (or characters) can be easily
     *       put out.</li>
     * </ul>
     * @param {string} sFormat
     * @params {any} _ Values
     * @return {string}
     */
    sprintf: function jsx_string_sprintf (sFormat) {
      var
        rxFormatSpec = _rxPrintfSpec,
        args = arguments,
        i = 1,
      ...
      return String(sFormat).replace(
        ...
        function (m, p1, propertyName, flags,
          ...
          if (argFieldWidth)
          {
            ...
            {
              /*
               * Re-declaration prevents argument change
               * by parameter assignment in non-strict mode
               */
              var uFieldWidthArg = i + 1;
            }
            else
            {
            ...
            var fieldWidth = args[uFieldWidthArg];
          }
          ...
          switch (convSpecifier)
          {
            ...
            case "A":
              v = [].join.call(
                [].map.call(v, function (element) {
                  return jsx_string_sprintf(
                    "%" + (p1 || "") + (flags || "")
                      + (fieldWidth || "" ) + "s",
                    element);
                }),
            ...
            case "X":
              ...
              case "G":
                ...
                /*
                 * TODO: Use Number.prototype.toExponential() if
                 * backwards-compatible
                 */
                if (/e/i.test(convSpecifier))
                {
                  var numParts =
                    v.match(/^([+-])?(\d*)(\.(\d*))?(e([+-]\d+))?/i), sign =
                    numParts[1] || "", sUintPart = numParts[2], uintPart =
                    sUintPart && parseInt(sUintPart, 10) || 0, fracPart =
                    numParts[4] || "", exponent =
                    numParts[6] && parseInt(numParts[6], 10) || 0;
                  ...
                  else if (fracPart)
                  {
                    ...
                    var numLeadingZeroes = (fracPart.match(/^0+/) || [
                      ""
                    ])[0].length;
            ...
            if (fieldWidth)
            {
              ...
              if (flags.indexOf("0") > -1
                && /[bdoxXiueEfFgG]/.test(convSpecifier))
              {
                v = String(v);

                var padCharacter = "0", wasNegative = (v.charAt(0) === "-");
    ...
    /**
     * Uses a string as template for formatting values.
     *
     * @param {string} sFormat
     * @return {String}
     */
    ...
    sscanf: (function () {
      ...
      var rxFormatSpec = _rxPrintfSpec;
    ...
    */
     ...
     */
    stripTags: function (s, bStripContent, bCaseSensitive, tags, bElements) {
      if (!s)
      {
        s = this;
      }
     ...
     * @fixme belongs in regexp.js
     */
    strArrayToCharClass: function (as) {
      var hashTable = [];
     ...
     * @fixme Move to string/python.js
     */
    pyUTF8toString: function (s) {
      return unesc(
        s.replace(/[\x80-\xff]/g,
          function (m) {
...
/** @deprecated in favor of {@link jsx.string.CH_NBSP} */
var CH_NBSP = jsx.string.CH_NBSP;

/** @deprecated in favor of {@link jsx.string.StringException} */
var StringException = jsx.string.StringException;

/** @deprecated in favor of {@link jsx.string.addSlashes} */
var addSlashes = jsx.string.addSlashes;

/** @deprecated in favor of {@link jsx.string.escape} */
var esc = jsx.string.escape;

/** @deprecated in favor of {@link jsx.string.escapeURI} */
var escURI = jsx.string.escapeURI;

/** @deprecated in favor of {@link jsx.string.unescape} */
var unesc = jsx.string.unescape;

/** @deprecated in favor of {@link jsx.string.format1k} */
var format1k = jsx.string.format1k;

/** @deprecated in favor of {@link jsx.string.hashCode} */
var hashCode = jsx.string.hashCode;

/** @deprecated in favor of {@link jsx.string.leadingCaps} */
var leadingCaps = jsx.string.leadingCaps;

/** @deprecated in favor of {@link jsx.string.leadingZero} */
var leadingZero = jsx.string.leadingZero;

/** @deprecated in favor of {@link jsx.string.levenshtein} */
var levenshtein = jsx.string.levenshtein;

/** @deprecated in favor of {@link jsx.string.maskMarkup} */
var maskMarkup = jsx.string.maskMarkup;

/** @deprecated in favor of {@link jsx.string.nl2br} */
var nl2br = jsx.string.nl2br;

/** @deprecated in favor of {@link jsx.string.pad} */
var pad = jsx.string.pad;

/** @deprecated in favor of {@link jsx.string.replaceText} */
var replaceText = jsx.string.replaceText;

/** @deprecated in favor of {@link jsx.string.serialize} */
var serialize = jsx.string.serialize;

/** @deprecated in favor of {@link jsx.string.count} */
var strCount = jsx.string.count;

/** @deprecated in favor of {@link jsx.string.equals} */
var strCompare = jsx.string.equals;

/** @deprecated in favor of {@link jsx.string.stripTags} */
var stripTags = jsx.string.stripTags;

/** @deprecated in favor of {@link jsx.string.repeat} */
var strRepeat = jsx.string.repeat;

/** @deprecated in favor of {@link jsx.string.strToArray} */
var strToArray = jsx.string.strToArray;
...
/** @deprecated in favor of {@link jsx.string.strArrayToCharClass} */
var strArrayToCharClass = jsx.string.strArrayToCharClass;

/** @deprecated in favor of {@link jsx.string.strToCodeArray} */
var strToCodeArray = jsx.string.strToCodeArray;
...
/** @deprecated in favor of {@link jsx.string.trim} */
var trim = jsx.string.trim;

/** @deprecated in favor of {@link jsx.string.trimLeft} */
var trimLeft = jsx.string.trimLeft;

/** @deprecated in favor of {@link jsx.string.trimRight} */
var trimRight = jsx.string.trimRight;

/** @deprecated in favor of {@link jsx.string.pyUTF8toString} */
var pyUTF8toString = jsx.string.pyUTF8toString;
...
if (jsx.options.augmentBuiltins)
{
  jsx.object.extend(String, {
     ...
     */
    version: jsx.string.version,

    /** @deprecated in favor of {@link jsx.string.copyright} */
    copyright: jsx.string.copyright,

    /** @deprecated in favor of {@link jsx.string.author} */
    author: jsx.string.author,

    /** @deprecated in favor of {@link jsx.string.email} */
    email: jsx.string.email,

    /** @deprecated in favor of {@link jsx.string.path} */
    path: jsx.string.path,

    /** @deprecated in favor of {@link jsx.string.docURL} */
    docURL: jsx.string.docURL,
...
/*
 * NOTE: Had to abandon extend since KJS does not support
 * Object literals
 * FIXME: Still true?
 */
...
if (typeof Number.prototype.toFixed == "undefined")
{
  ...
  Number.prototype.toFixed = function (iPrecision) {
    ...
    {
      result = _pad(result, iPrecision, '0', true, decLen);
    }
    else
    {
...
{
  var parseFloat = jsx.string.parseFloat;
}
