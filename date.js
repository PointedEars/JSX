...
if (typeof Date.prototype.strftime == "undefined")
{
  ...
  Date.prototype.strftime = (function () {
    ...
    return function Date_prototype_strftime (format) {
      ...
      return String(format).replace(_rxDateFormats, _formatter.bind(this));
    };
  }());

  Date.prototype.strftime.WEEKDAYS = [
    ["Sun", "Sunday"], ["Mon", "Monday"], ["Tue", "Tuesday"],
    ["Wed", "Wednesday"], ["Thu", "Thursday"], ["Fri", "Friday"],
    ["Sat", "Saturday"]
  ];

  Date.prototype.strftime.MONTHS = [
  ...
  Date.prototype.strftime.DAYTIMES = {am: "am", pm: "pm"};

  Date.prototype.strftime.TIMEZONES = {
    "0":    "GMT",
    "-60":  "CET",
    "-120": "CEST"
  };
